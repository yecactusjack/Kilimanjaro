      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="bg-white p-8 rounded-md border border-gray-100 hover:shadow-sm transition-shadow">
            ...
            <p className="text-gray-600">Upload genomic data files for analysis. Supports FASTQ, BAM, VCF, and other formats.</p>
          </div>
          <div className="bg-white p-8 rounded-md border border-gray-100 hover:shadow-sm transition-shadow">
            <h3 className="text-xl font-bold mb-4">Interactive Chat</h3>
            <p className="text-gray-600">Conversational interface with AI for complex bioinformatics queries and visualizations.</p>
          </div>
          <div className="bg-white p-8 rounded-md border border-gray-100 hover:shadow-sm transition-shadow">
            <h3 className="text-xl font-bold mb-4">Question Answering</h3>
            <p className="text-gray-600">Ask specific questions about your genomic data and get detailed, accurate answers.</p>
          </div>
        </div>
      </div>
    </section>
